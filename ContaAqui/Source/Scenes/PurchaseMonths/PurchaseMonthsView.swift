...
class PurchaseMonthsView: UIView {
    ...
    public let moneyInput: Input = {
        let field = Input(placeHolder: "0,00", textLeft: "R$")
        field.translatesAutoresizingMaskIntoConstraints = false
        
        return field
    }()
    
    public let purchaseButton: Button = {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            launchContainer.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -40),
